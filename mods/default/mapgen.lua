...
minetest.register_alias("mapgen_leaves", "default:inv")
minetest.register_alias("mapgen_apple", "default:apple")
minetest.register_alias("mapgen_jungletree", "default:jungletree")
minetest.register_alias("mapgen_jungleleaves", "default:inv")
minetest.register_alias("mapgen_junglegrass", "default:junglegrass")
minetest.register_alias("mapgen_pine_tree", "default:pine_tree")
minetest.register_alias("mapgen_pine_needles", "default:inv")
...
function default.register_ores()
	...
	minetest.register_ore({
		ore_type       = "scatter",
		ore            = "default:toxic_water_source",
		wherein        =  "default:mud",
		...
		ore_type       = "scatter",
		ore            = "default:toxic_water_source",
		wherein        =  {"default:dry_dirt", "default:dirt_with_dry_grass"},
		clust_scarcity = 11*5*10,
		clust_num_ores = 4,
		clust_size     = 12,
		y_min          = -31,
...
function default.register_mgv6_decorations()
	...
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"default:desert_sand", "default:dirt_with_snow", "default:dirt_with_dry_grass"},
		sidelen = 16,
		noise_params = {
			offset = 0,
			scale = 0.035,
...
function default.register_decorations()
	...
	minetest.register_decoration({
		deco_type = "schematic",
		place_on = {"default:dirt_with_dry_grass", "default:dry_dirt"},
		sidelen = 16,
		noise_params = {
			offset = 0.004,
			scale = 0.002,
		...
		biomes = {"deciduous_forest", "jungle", "coniferous_forest", "rainforest"  },
		y_min = 1,
		y_max = 31000,
...
local function register_grass_decoration(offset, scale, length)
	...
	minetest.register_decoration({
		deco_type = "schematic",
		place_on = {"default:snowblock", "default:dirt_with_dry_grass", "default:dry_dirt"},
		sidelen = 16,
		noise_params = {
			offset = 0.004,
			scale = 0.02,
	...
	minetest.register_decoration({
		deco_type = "simple",
		place_on = {"default:desert_sand", "default:dirt_with_snow", "default:dry_dirt","default:dirt_with_dry_grass"},
		sidelen = 16,
		noise_params = {
			offset = 0,
			scale = 0.2,
		...
		biomes = {"desert", "tundra","stone_grassland", "stone_grassland_ocean",
			"sandstone_grassland", "sandstone_grassland_ocean",
			"deciduous_forest", "deciduous_forest_ocean",
			"coniferous_forest", "coniferous_forest_ocean","deciduous_forest", "jungle", "coniferous_forest", "savanna_ocean", "desert_ocean", "rainforest","rainforest_ocean"  ,"rainforest_swamp" },
		y_min = -6,
		y_max = 31000,
		decoration = "default:dry_shrub",
	})
