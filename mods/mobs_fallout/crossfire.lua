...
mobs:register_mob("mobs_fallout:Mr_White", {
	...
	textures = {{"Infantry_man_by_philipbenr.png^[colorize:white:90",
			"3d_armor_trans.png",
...
mobs:register_mob("mobs_fallout:Mr_Black", {
	...
	visual = "mesh",
	mesh = "3d_armor_character.b3d",
	textures = {{"Infantry_man_by_philipbenr.png^[colorize:gray:90",
			"3d_armor_trans.png",
				minetest.registered_items["shooter:pistol"].inventory_image,
			}},
	visual_size = {x=1, y=1},
...
mobs:register_mob("mobs_fallout:Mr_Pink", {
	...
	visual = "mesh",
	mesh = "3d_armor_character.b3d",
	textures = {{"Infantry_man_by_philipbenr.png^[colorize:pink:90",
			"3d_armor_trans.png",
